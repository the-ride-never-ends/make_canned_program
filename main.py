...
from utils.pull_requested_modules_from_github import pull_requested_modules_from_github
...
def main():
    ...
    # Step 3. Pull the requested modules from GitHub.
    pull_requested_modules_from_github(chosen_modules)


    # Step 4. Create the folder with chosen program name in the home directory
    ...
    # Step 10. Remove the underscore from all file names in the main folder. 
    remove_underscores(program_path)


    # Step 11. Create debug, input, and output folders.
